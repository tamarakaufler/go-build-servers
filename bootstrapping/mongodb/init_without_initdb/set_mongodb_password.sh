...
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-url_shortener}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-shorty_user}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-shortypass}
